    ...
    if (request.host) {
        ...
        if (overallScore) {
            yield chrome.storage.sync.set({
                host: request.host,
                score: overallScore === null || overallScore === void 0 ? void 0 : overallScore.data,
