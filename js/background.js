...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (request.host) {
        ...
        const overallScoreRounded = Number.parseFloat(overallScore === null || overallScore === void 0 ? void 0 : overallScore.data).toFixed(2);
        const profileLink = yield (0, bcorp_1.bcorpProfile)(request.host);
        if (overallScore) {
            yield chrome.storage.sync.set({
                host: request.host,
                score: overallScoreRounded,
                link: profileLink === null || profileLink === void 0 ? void 0 : profileLink.data,
                loading: false,
            });
        }
        yield chrome.storage.sync.set({
...
const bcorpOverall = (host, secondTime) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const res = yield axios_1.default.get(`https://bizdataapi.azurewebsites.net/Biz/GetOverAllScore?website=${host}`);
        // console.log('bcorpOverall res: ', res);
        if ((res === null || res === void 0 ? void 0 : res.data) === '' && !secondTime) {
...
const bcorpProfile = (host, secondTime) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const res = yield axios_1.default.get(`https://bizdataapi.azurewebsites.net/Biz/GetBcorpProfile?website=${host}`);
